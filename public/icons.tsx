...
export const ArrowRotated = ({ style }: ArrowRotated) => {
  return (
    <svg
      className={style}
      width="26" 
...
export const BlueLArrowIcon = ({ style }: { style?: string }) => {
  return (
    <svg
      width="18"
      height="14"
    ...
    >
      <path
        d="M0.363604 6.3636C0.012132 6.71508 0.012132 7.28492 0.363604 7.6364L6.09117 13.364C6.44264 13.7154 7.01249 13.7154 7.36396 13.364C7.71543 13.0125 7.71543 12.4426 7.36396 12.0912L2.27279 7L7.36396 1.90883C7.71543 1.55736 7.71543 0.987511 7.36396 0.636039C7.01249 0.284567 6.44264 0.284567 6.09117 0.636039L0.363604 6.3636ZM17 7.9C17.4971 7.9 17.9 7.49706 17.9 7C17.9 6.50294 17.4971 6.1 17 6.1V7.9ZM1 7.9H17V6.1H1V7.9Z"
        fill="#0078AF"
      />
    </svg>
  );
