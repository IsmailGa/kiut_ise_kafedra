  ...
  const courses = [
    {
      ...
      descr:
        "Узнаете, как работает компьютер и интернет, познакомитесь с профессией фронтенд-разработчика и основными инструментами.",
    },
    {
      title: "Название предмета",
      descr:
  ...
  return (
    <section className="flex flex-col mt-[120px] w-full bg-[#F7F7F7] rounded-[30px] gap-[45px] py-[35px] px-[40px]">
      <div className="flex flex-col gap-[16px]">
        <h1 className="text-[56px] leading-[140%] font-semibold">Программа</h1>
        {/* INFO LIST */}
        ...
        <div className="flex flex-col gap-[12px]">
          ...
          <ul className="flex flex-col gap-[16px]">
            {courses.map((course, index) => (
              <li
                key={index}
                className="flex items-center gap-[8px] py-[24px] px-[30px] bg-white rounded-[25px] transition-colors duration-200 group cursor-pointer hover:bg-[#CEDAE0] active:"
              >
                <div className="flex flex-col">
                  <h4 className="text-[24px] font-semibold leading-[125%]">
                    {course.title}
                  </h4>
                ...
                {/* ARROW DOWN */}
                <div className="rounded-full w-[50px] h-[50px] bg-[#F4F4F4] group-hover:bg-primary transition-colors duration-200 flex items-center justify-center">
                  <svg
                    width="28"
                    height="28"
                    viewBox="0 0 28 28"
                  ...
                  >
                    <path
                      ...
                      className="stroke-[#292D32] group-hover:stroke-white transition-colors duration-200"
                    />
                  </svg>
                </div>
              </li>
