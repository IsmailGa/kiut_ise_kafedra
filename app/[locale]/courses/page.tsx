        ...
        <Container>
          <div className="w-full flex flex-col gap-[25px] 2xl:mb-[65px] mb-[45px] items-center">
            ...
            <p className="2xl:max-w-[667px] max-w-[580px] xl:text-[18px] text-[16px] text-[#666666] font-normal leading-[120%]">
              ...
              информационных технологий, что позволяет студентам выбрать свою
              нишу
            </p>
          </div>
          {/* CARDS */}
          <div className="grid grid-cols-2 items-center flex-col gap-[30px] mb-[45px]">
            ...
            <Link href="/courses/bachelors">
              <div className="xl:h-[310px] h-[280px] flex flex-col justify-between p-[25px] rounded-[25px] bg-[#F4F4F4]/65 overflow-hidden relative group">
                ...
                <div className="absolute xl:w-[310px] w-[250px] h-auto aspect-square right-0 bottom-0 translate-y-[20%] translate-x-[7%]">
                  <Image
                    src={bg_two}
