            ...
            <div className="flex flex-col items-center justify-center gap-[32px]">
              ...
              <div className="flex w-full max-w-[530px]">
                <label htmlFor="kiut_search" className="relative flex w-full">
                  <input type="text" name="kiut_search" placeholder="Поиск" id="kiut_search" className="bg-[#F0F0F0] outline-none text-[#666666] placeholder:text-[#666666] text-[18px] font-medium w-full h-[55px] px-[30px] rounded-[15px]"/>
